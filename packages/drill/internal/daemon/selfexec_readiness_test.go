...
func TestStartDetachedDaemonDetectsChildExitPromptly(t *testing.T) {
	...
	t.Setenv("DRILL_DAEMON_HELPER_PROCESS", "exit")
	t.Setenv("DRILL_TEST_DAEMON_START_TIMEOUT", "3s")
	t.Setenv("DRILL_TEST_DAEMON_START_POLL_INTERVAL", "10ms")
...
func TestWaitForManagedDaemonStartDetectsPublishedChildExit(t *testing.T) {
	...
	cmd.Env = append(os.Environ(), "DRILL_DAEMON_HELPER_PROCESS=block")
...
func TestStartDetachedDaemonTimeoutKillsAndReapsChild(t *testing.T) {
	...
	t.Setenv("DRILL_TEST_DAEMON_START_TIMEOUT", "40ms")
	t.Setenv("DRILL_TEST_DAEMON_START_POLL_INTERVAL", "5ms")
