...
func TestServiceDefinitionMatchesRootRejectsPrefixOnlyMatch(t *testing.T) {
	...
	if serviceDefinitionMatchesRoot([]byte(renderLaunchAgent("/opt/drill/bin/drill", other, home)), p) {
		t.Fatal("expected launch agent root prefix collision to be rejected")
	}
	if serviceDefinitionMatchesRoot([]byte(renderSystemdUnit("/usr/local/bin/drill", other, home)), p) {
	...
	if !serviceDefinitionMatchesRoot([]byte(renderLaunchAgent("/opt/drill/bin/drill", p, home)), p) {
		t.Fatal("expected exact launch agent root match")
	}
	if !serviceDefinitionMatchesRoot([]byte(renderSystemdUnit("/usr/local/bin/drill", p, home)), p) {
...
func TestRenderLaunchAgentIncludesManagedPath(t *testing.T) {
	...
	plist := renderLaunchAgent("/opt/drill/bin/drill", p, home)
...
func TestRenderSystemdUnitIncludesManagedPath(t *testing.T) {
	...
	unit := renderSystemdUnit("/usr/local/bin/drill", p, home)
...
func TestManagedServicesRouteRawOutputToBootstrapSink(t *testing.T) {
	...
	plist := renderLaunchAgent("/opt/drill/bin/drill", p, "/Users/test")
	...
	unit := renderSystemdUnit("/usr/local/bin/drill", p, "/home/test")
