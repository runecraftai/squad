...
CREATE TABLE IF NOT EXISTS runs (
    ...
    specialized_review_enabled INTEGER NOT NULL DEFAULT 0,
...
var migrationStatements = []string{
	...
	`ALTER TABLE runs ADD COLUMN drill_version TEXT`,
	`ALTER TABLE runs ADD COLUMN drill_build_sha TEXT`,
	...
	`ALTER TABLE runs ADD COLUMN specialized_review_enabled INTEGER NOT NULL DEFAULT 0`,
