// Command genskill renders the canonical drill SKILL.md from the
// internal/skill package into skills/drill/SKILL.md. The same rendering
// is what `drill init` installs into the user-level agent skill
