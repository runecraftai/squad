...
export const SKILL_DESCRIPTION =
  "Operate GitHub through the sq-gh CLI - issues, pull requests, workflow runs, workflows, " +
 ...
 * command list can never drift from what `sq-gh --help` prints.
 */
...
/**
 * Render the installable SKILL.md for the sq-gh skill. The body is built
 * from the same shared guidance the CLI prints (description and top-level
 * help), rewriting invocations to non-interactive `npx -y @runecraft/sq-gh ...` so the
