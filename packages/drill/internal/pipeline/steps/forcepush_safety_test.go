...
// Issue #281: after drill opens a PR, a reviewed commit is pushed to
...
func TestCIStep_CommitAndPush_RefusesToClobberUnseenUpstreamCommit(t *testing.T) {
	...
	gitCmd(t, dir, "push", "origin", "feature") // origin feature == H1, what drill last saw
...
// Issue #305: drill rebased onto a stale view of upstream and then the
