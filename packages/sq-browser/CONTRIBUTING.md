...
3. Initialize or refresh the gate with your fork as the push target: `drill init --fork-url git@github.com:<you>/sq-browser.git`.
...
- Do not hand-edit `skills/sq-browser/SKILL.md`.
...
- Keep `skills/sq-browser/` in the npm package `files` list so releases include the installable Agent Skill.
