...
fob without --lease reports an upgrade, gh auth is fine^0^0.2.4^1^-^grep^MISSING: fob (install: curl -fsSL https://kunchenguid.github.io/fob/install.sh | sh)^NEEDS_GH_AUTH
