...
`drill` exists so that one deliberate push means a change was independently validated before anyone else sees it.
...
drill is a local tool for the person whose credentials and accountability are on the line; runs happen on their machine, under their identity, at their initiative.
