...
func TestReviewPipelineOwnedPRCriterionDoesNotPark(t *testing.T) {
	...
	parentURL := "https://github.com/example/drill.git"
	forkURL := "https://github.com/example-fork/drill.git"
	...
	t.Setenv("FAKEAGENT_GH_PARENT", "example/drill")
	...
	if completed.PRURL == nil || *completed.PRURL != "https://github.com/example/drill/pull/99" {
