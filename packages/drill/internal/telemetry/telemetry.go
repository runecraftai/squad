...
const (
	defaultHostname = "cli"
	defaultTitle    = "drill CLI"
	defaultPath     = "/api/send"
	defaultHost     = "https://a.squad.example"

	umamiHostEnv      = "DRILL_UMAMI_HOST"
	umamiWebsiteIDEnv = "DRILL_UMAMI_WEBSITE_ID"
	telemetryEnv      = "DRILL_TELEMETRY"
)
...
func (c *Client) send(ctx context.Context, payload []byte) {
	...
	req.Header.Set("User-Agent", fmt.Sprintf("drill/%s telemetry", c.version))
