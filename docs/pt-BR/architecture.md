...
A curadoria de memória do `/debrief` usa inspect-then-update: ela lê o destino atual primeiro, depois reescreve ou poda bullets ou notas correspondentes in-place em vez de appendar por padrão.
