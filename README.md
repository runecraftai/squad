...
- [docs/sq-sidebar.md](docs/sq-sidebar.md) - the Operations Board: session-scoped global sidebar with per-operator cards, layout modes, navigation keys, and dashboard commands.
