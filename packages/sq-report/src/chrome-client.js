...
const queueStorageKey = "sq-report:queued:" + key;
...
const warningSelectionStorageKey = "sq-report:warning-selection:" + key;
...
function setLayoutGateCard(state) {
  ...
  layoutGateCopy.textContent = "sq-report is waiting for fonts and final geometry before revealing this artifact.";
}
