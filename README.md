...
- [docs/sq-sidebar.md](docs/sq-sidebar.md) - the Squad tmux sidebar (workmux fork): per-window status cards from the ground-truth state files in a togglable pane.
