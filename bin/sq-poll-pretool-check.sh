#!/usr/bin/env bash
# Primary-only PreToolUse transport for blocking hand-polling of state/ files.
# The transport owns payload extraction, primary scope, and fail-open behavior;
# bin/sq-poll-command-policy.mjs owns shell classification.
...
POLICY="$SQUAD_ROOT/bin/sq-poll-command-policy.mjs"
