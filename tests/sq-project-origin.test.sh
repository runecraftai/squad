#!/usr/bin/env bash
# tests/sq-project-origin.test.sh - which project origins seeding accepts.
#
...
. "$ROOT/bin/sq-project-origin-lib.sh"

TMP_ROOT=$(fm_test_tmproot sq-project-origin)
...
# Squad is a shared template, so acceptance is decided by structure alone.
...
accepts 'https://github.com/kunchenguid/Squad.git'
accepts 'git@github.com:kunchenguid/Squad.git'
