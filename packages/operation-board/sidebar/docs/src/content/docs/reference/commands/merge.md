...
If your workflow uses pull requests, the merge happens on the remote after review. In that case, use [`workmux remove`](/reference/commands/remove/) to clean up the worktree after your PR is merged.
:::
