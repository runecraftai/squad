...
A seção Guard Predicates de [`turnend-guard.md`](turnend-guard.md#predicados-do-guard) é dona da validação de marcadores, detecção de checkout simples e paths exigidos em formato Squad.
