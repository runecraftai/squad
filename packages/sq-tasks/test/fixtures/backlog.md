...
## In flight
- **owns-widget-h7** - PERSISTENT XO (kind=xo, home ~/work/widget, harness claude). Owns the widget end to end including the release cycle, CI, and the store review watch. Idle pane is healthy; supervised by status writes. (since 2026-06-22)
...
- Release domain (owned by owns-widget-h7): 1.0.4 IN REVIEW; next release held. Full detail in the XO home.
...
- [x] fork-fix-k4 - canonical STRIKE (builder, PR https://github.com/acme/builder/pull/306, commander-merged, released v1.30.0): clean-slate fork-routing fix. Superseded contributor #296 (closed w/ link). Unblocks the fork-contribution flow. (merged 2026-06-21)
