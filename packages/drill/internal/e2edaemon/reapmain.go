...
func main() {
	if os.Getenv("DRILL_E2E_REAP_ABANDONED") == "1" {
		for _, err := range e2edaemon.ReapAbandoned(os.Getenv("DRILL_E2E_DAEMON_INVENTORY_PARENT"), os.Getenv(e2edaemon.EnvInventory)) {
	...
	if os.Getenv("DRILL_E2E_REAP_VERBOSE") == "1" {
