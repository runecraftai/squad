...
3. Initialize or refresh the gate with your fork as the push target: `drill init --fork-url git@github.com:<you>/sq-gh.git`.
...
- Do not hand-edit `skills/sq-gh/SKILL.md`.
