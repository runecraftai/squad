...
func TestOpenCodeReader_DiscoverAcceptsSameRemoteDifferentCheckout(t *testing.T) {
	originCWD := initGitRepoWithRemote(t, filepath.Join(t.TempDir(), "origin"), "git@github.com:runecraftai/squad/packages/drill.git")
	sessionCWD := initGitRepoWithRemote(t, filepath.Join(t.TempDir(), "fob"), "https://github.com/runecraftai/squad/packages/drill.git")
