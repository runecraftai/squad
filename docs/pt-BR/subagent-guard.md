...
Este é o mesmo predicado usado por `bin/sq-sessionstart-nudge.sh` e `bin/sq-turnend-guard.sh`, e os guards de backend e polling também o usam, então esses guards com escopo primário não podem divergir.
