...
// process already holds the lock for the same DRILL_HOME.
var ErrSingletonLockHeld = errors.New("a drill daemon is already running for this DRILL_HOME")

// singletonLock guards DRILL_HOME against more than one live daemon process.
