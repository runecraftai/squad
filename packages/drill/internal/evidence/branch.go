...
const DefaultBranch = "drill/evidence"

// MarkerPath is the file every drill evidence branch carries at its
...
const MarkerPath = ".drill-evidence"
...
const MarkerContent = `This branch holds test evidence published by drill.
