...
| sq-gh      | GitHub CLI wrapper for agents with token-efficient output, next-step suggestions, structured errors, and AXI JSON output            | [README](packages/sq-gh/README.md)           |
...
| sq-board   | Mission-planning board that renders the backlog queue with live operational state and optional GitHub issue monitoring from Squad's durable state files | [README](packages/operation-board/README.md) |
| squad-ui   | Dashboard for the Squad agent harness                                                                                           | [README](packages/squad-ui/README.md)        |
...
- [docs/sq-sidebar.md](docs/sq-sidebar.md) - the Squad tmux sidebar (vendored workmux): per-window status cards from the ground-truth state files in a togglable pane.
