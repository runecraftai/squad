...
The Claude and Codex session-control forms are reserved so drill can keep review-loop conversations deterministic: review turns stay session-free while the fixer keeps its own isolated durable session.
