 ...
 * Keep this aligned with the repo-wide audit rule: node -> package.json
...
function expectedReleaseOutputs(): string[] {
  ...
  const pkgKey = "packages/sq-quota";
...
describe("release-please CI exclusions", () => {
  ...
  it("derives the node release-output set for this repository", () => {
    expect(expected).toEqual([
      "packages/sq-quota/CHANGELOG.md",
      "packages/sq-quota/package.json",
      "packages/sq-quota/.release-please-manifest.json",
    ]);
  });
