...
Full documentation: <https://squad.example/no-mistakes/>
...
See the [quick start](https://squad.example/no-mistakes/start-here/quick-start/) for the full first-run walkthrough.
