...
const (
	launchdServiceLabelBase = "com.squad.no-mistakes.daemon"
...
const (
	legacyLaunchdServiceLabel = "com.squad.no-mistakes.daemon"
...
//
// Without scoping, the launchd label com.squad.no-mistakes.daemon (and
// its systemd/Windows equivalents) is a shared slot. Any no-mistakes process
// on the machine can `launchctl bootout gui/<uid>/com.squad.no-mistakes.daemon`
