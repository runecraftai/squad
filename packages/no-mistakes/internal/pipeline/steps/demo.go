...
func DemoSteps() []pipeline.Step {
	return []pipeline.Step{
		...
		&demoStep{
			...
			log:        "Running: go test -race ./...\n\nok  \tgithub.com/runecraftai/squad/packages/no-mistakes/internal/handler\t1.2s\nok  \tgithub.com/runecraftai/squad/packages/no-mistakes/internal/config\t0.8s\nok  \tgithub.com/runecraftai/squad/packages/no-mistakes/internal/server\t1.5s\n\nPASS",
		},
		&demoStep{
		...
		&demoStep{
			...
			delay:      3 * time.Second,
			displayDur: 8 * time.Second,
			log:        "Creating pull request...\nhttps://github.com/runecraftai/squad/packages/no-mistakes/pull/42",
			prURL:      "https://github.com/runecraftai/squad/packages/no-mistakes/pull/42",
		},
		&demoCIStep{
