...
O turn-end guard do Claude é dono da progressão monótonica de falhas, fail-open assistido único, supressão de continuação pós-alarme e reset positivo de recuperação descritos em [`turnend-guard.md`](turnend-guard.md#integrações-por-harness).
