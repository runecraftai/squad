...
hero:
  ...
  actions:
    - text: Get Started
      link: /drill/start-here/quick-start/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
      link: https://github.com/squad-org/squad/packages/drill
      icon: external
---
...
branch is already public. `drill` moves more of that loop closer to where
you are working.
...
flowchart LR
  ...
  subgraph after[" With drill "]
    direction TB
    E["Local branch"] -->|"git push drill"| F["Local gate"]
...
- [Quick Start](/drill/start-here/quick-start/) - first gated push in a few minutes
- [Introduction](/drill/start-here/introduction/) - why the tool exists and how to think about it
- [The Gate Model](/drill/concepts/gate-model/) - architecture, push flow, and design choices
